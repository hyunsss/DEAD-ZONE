...
namespace KINEMATION.FPSAnimationFramework.Runtime.Layers.SwayLayer
{
    ...
    public class SwayLayerState : FPSAnimatorLayerState
    {
        ...
        {
            bool useFreeAim = _inputController.GetValue<bool>(_settings.useFreeAimProperty);
        ...
        {
            Vector4 moveInput = _inputController.GetValue<Vector4>(_settings.moveInputProperty);
        ...
        public override void OnEvaluatePose()
        {
            ...
            _mouseDelta = _inputController.GetValue<Vector4>(_settings.mouseDeltaInputProperty);
